...
| CAI-004 | Blocked (credential/config); admin+PHI allowed | 100310; 100300 on admin+PHI | **Pass** (remediated) |
...
5. Residual risk (CAI-004 and CAI-006 remediated; admin RBAC and content-level RAG provenance documented)
